...
@app.callback([dash.dependencies.Output('your-output-here', 'children'), dash.dependencies.Output('show-image', 'src')],
...
def display_value(whatever_you_chose):
    ...
    if whatever_you_chose == "initial":
        print("000000000")
        return (f'Lets listen to some real jazz from Blue Note Records.',
                app.get_asset_url('blue_note_logo.jpeg'))
    else:
        print("11111111")
        return (f'Lets listen to something from {whatever_you_chose}.',
                app.get_asset_url(image_list[list_of_choices.index(whatever_you_chose)]))
